...
func Run(args []string, stdin io.Reader, stdout, stderr io.Writer, a Options) int {
	...
	rt, err := coderengaruntime.New(context.Background(), coderengaruntime.Options{BinaryDir: bin, CWD: cwd, ConfigPath: o.ConfigPath, StateDir: o.StateDir, Mode: o.Mode, Profile: o.Profile, Model: o.Model, NoPersist: o.NoPersist, DryRun: o.DryRun})
	if err != nil {
